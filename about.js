...
const I18N = {
  ru: {
    ...
    whoTitle: "Кто я",
    whoP1: "Меня зовут Виталиия Сивакова — основательница VS LiteCode Studio, современной веб студии, где дизайн, технология и креативность соединяются в одном потоке. Я создаю цифровые решения, которые работают безупречно, выглядят современно и передают настроение человека или бренда.",
