...
const translations = {
    sv: {
        ...
        "albumFamily.cta": "Om du gillar det här formatet kan du bara skriva till mig via kontaktformuläret и berätta vilket album som passar dig bäst: graviditet, barnets första år, ett familjeår i bilder och så vidare.",
    ...
    ru: {
        ...
        "albumFamily.exampleWedding": "💍 Свадебный альбом – элегантный, нежный дизайн с магическими эффектами и плавными переходами.",
        "albumFamily.cta": "Если тебе нравится такой формат, просто напиши мне через форму на странице контактов и укажи, какой альбом тебе ближе.",
